      ...
      public void executeQuery(String query, String msg)
   {
       ...
       try{    
           ...
           if((st.executeUpdate(query)) == 1)
           {
               ...
               jTextField4.setText("");
               jTextField5.setText("");
               JOptionPane.showMessageDialog(null, "New Cashier "+msg+" Succefully");
               
           }else{
               JOptionPane.showMessageDialog(null, "Cashier "+msg);
           }
    ...
    private void initComponents() {
        ...
        anew.setBackground(new java.awt.Color(255, 255, 255));
        anew.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        anew.setText("Add New");
        anew.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        anew.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        del.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        del.setText("Delete");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(anew, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void anewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anewActionPerformed
        String query="INSERT INTO `Cashiers`(`name`,`address`,`num`,`email`,`password`) VALUES('"+jTextField2.getText()+"','"+jTextField4.getText()+"','"+jTextField3.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"');";
        executeQuery(query, "Inserted");
    }//GEN-LAST:event_anewActionPerformed

    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        String query="DELETE FROM `Cashiers` WHERE `id`="+jTextField1.getText();
